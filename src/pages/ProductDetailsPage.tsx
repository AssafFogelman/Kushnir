...
const mockProducts: Product[] = [
  {
    ...
    variations: [
      ...
      },
      {
        ...
        price: 1300,
        images: [
          "/images/products/bookshelf/dark/1.jpg",
          "/images/products/bookshelf/dark/2.jpg",
        ],
      },
      {
        id: "1-3",
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          {product.variations && (
            <div className="mt-4">
              <h3 className="text-lg font-medium mb-2">{t("variations")}</h3>
        ...
        <div className="space-y-6">
          ...
          {product.dimensions && (
            <div>
              <h3 className="font-medium">{t("dimensions")}</h3>
